...
Name_of_calculation = 'calculation_numerical_improved_final_setup_0.02@50'
...
intersection_boundary_edge = 0.005 #meters, defines a boundary layer around the edge of the setup for which intersections will not be included, generally to exclude the sensors from intersections
...
tube_width = 0.02 #Always pay close attention when using a precalculated gram matrix that the same tubewidth is used for sampling
